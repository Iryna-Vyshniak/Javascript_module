 ...
 * event.target - целевой (исходный) элемент, самый глубоко вложенный, тот, на который именно кликнули, в target всегда одно и то же, тот элемент на который кликнули
